...
import '../src/styles/miranda-styles/style.scss';
          ...
          <section className="hero text-light text-center">
            <div className="container-sm">
              <div className="hero-inner">
                <h1 className="hero-title h2-mobile mt-0 is-revealing">Modern Multi-Modal TMS</h1>
                ...
                <p className="hero-cta is-revealing">
                  <a className="button button-secondary button-shadow" href="#">
                    Get started now
                  </a>
                </p>
                ...
                <div className="container-sm">
                  <ul className="list-reset mb-0">
                    <li>
                      ...
                      <img className="client" src="/static/images/miranda/cs.png" />
                    </li>
                    <li>
                      <span className="screen-reader-text">Hub Group</span>
                      <img className="client" src="/static/images/miranda/hub.png" />
                    </li>
                    <li>
                      <span className="screen-reader-text">Deringer</span>
                      <img className="client" src="/static/images/miranda/deringer.png" />
                    </li>
                    <li>
            ...
            <div className="container">
              <div className="features-extended-inner section-inner has-top-divider">
                <div className="features-extended-header text-center">
                  <div className="container-sm">
                    <h2 className="section-title mt-0">Omni Modal that meets your needs</h2>
                    <p className="section-paragraph">A tms that is so great, you'll be amazed.</p>
                  </div>
                </div>
                <div className="feature-extended">
                  ...
                  <div className="feature-extended-body">
                    <h3 className="mt-0">Access to Industry Leading Rates</h3>
                ...
                <div className="feature-extended">
                  ...
                  <div className="feature-extended-body">
                    <h3 className="mt-0">Import your tariffs</h3>
                ...
                <div className="feature-extended">
                  ...
                  <div className="feature-extended-body">
                    <h3 className="mt-0">Tracking and shipping documents</h3>
                    <p>OTIF OSCA</p>
                  </div>
                </div>
              </div>
                ...
                <div className="features-wrap">
                  <div className="feature is-revealing">
                    <div className="feature-inner">
                      ...
                      <h4 className="feature-title h3-mobile">Automated</h4>
                      <p className="text-sm">Tracking, Dispatching, Shipping documents,</p>
                    </div>
                  </div>
                  <div className="feature is-revealing">
                    <div className="feature-inner">
                      ...
                      <h4 className="feature-title h3-mobile">Built for Scale</h4>
                      <p className="text-sm">
                        {' '}
                  ...
                  <div className="feature is-revealing">
                    <div className="feature-inner">
                      ...
                      <h4 className="feature-title h3-mobile">Enterprise Ready</h4>
                      <p className="text-sm">
                  ...
                  <div className="feature is-revealing">
                    <div className="feature-inner">
                      ...
                      <h4 className="feature-title h3-mobile">Shipping Notifications</h4>
                      <p className="text-sm">To stay n top of your freight</p>
                    </div>
                  </div>
                </div>
              </div>
                      ...
                      <div className="pricing-table-main">
                        <div className="pricing-table-header">
                          ...
                          <div className="pricing-table-price mb-24 pb-32">
                            ...
                            <span className="pricing-table-price-amount h1">29</span>
                          </div>
                        </div>
                    ...
                    <div className="pricing-table-inner">
                      <div className="pricing-table-main">
                        <div className="pricing-table-header">
                          ...
                          <div className="pricing-table-price mb-24 pb-32">
                            <span className="pricing-table-price-currency h3">$</span>
                            <span className="pricing-table-price-amount h1">129</span>
                          </div>
                        </div>
                        <ul className="pricing-table-features list-reset text-xs mb-56">
                          <li>
